...
<div style="margin-left: 30%; margin-right: 30%; background-color:Tan">
...
<form id="form1" name="form1" method="post" action="submitorder.php">
  ...
  <input type="text" name="lastName" id="lastName" ><br>
    ...
    <tbody>
      ...
      $query = "SELECT TYPE, count, price FROM INVENTORY";
...
<div class="w3-bottom w3-hide-small">
  <ul class="w3-navbar w3-white w3-center w3-padding-8 w3-opacity-min w3-hover-opacity-off">
    <li style="width:25%"><a href="LumberLadsMain.html" class="w3-margin-left w3-round">Home</a></li>
